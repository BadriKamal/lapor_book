...
class _DetailPageState extends State<DetailPage> {
  ...
  void komenDialog(Laporan laporan) {
    showDialog(
      context: context,
      builder: (BuildContext context) {
        return KomenDialog(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      laporan.gambar != ''
                          ...
                          : Image.asset('lib/assets/istock-default.png'),
                      SizedBox(height: 20),
                      Row(
                        ...
                        children: [
                          laporan.status == 'Posted'
                              ...
                              : laporan.status == 'Process'
                                  ? textStatus(
                                      'Process', Colors.blue, Colors.white)
                                  : textStatus(
                      ...
                      SizedBox(height: 10),
                      if (akun.role == 'admin' || akun.role == 'user')
                        Container(
                          width: 250,
                          child: ElevatedButton(
                            onPressed: () {
                              setState(() {
                                status = laporan.komentar as String?;
                              });
                              komenDialog(laporan);
                            },
                            style: TextButton.styleFrom(
